...
OUTPUT_RTSP = os.getenv("OUTPUT_RTSP", "rtsp://192.168.10.2:8554/chang_annot_6")

# Paths for uimain
UIMAIN_WORKDIR = "/root/project_nep/cside"
UIMAIN_MODEL = "backends/yolov8-onnx-cpp/checkpoints/yolov8n-seg.onnx"
...
def start_health_server():
    ...
    port = int(os.getenv("HEALTH_PORT", "7006"))
